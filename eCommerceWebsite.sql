...
-- 1). required to create tables for supplier,customer,category,product,supplier_pricing,order,rating to store the data for the ecommerce with the schema definition given below.
...
INSERT INTO supplier VALUES(1,'Rajesh Retails','Delhi',1234564490),
			                     (2,'Appario Ltd.','Mumbai',258963440),
                           (3,'Knome products','Banglore',978544415),
                           (4,'Bansal Retails','Kochi',8975344285),
                           (5,'Mittal Ltd.','Lucknow',789445532);

 -- INSERT RECORDS IN CUSTOMER TABLE
INSERT INTO customer VALUES(1,'AKASH',999943534,'DELHI','M'),
			   (2,'AMAN',9785463215	,'NOIDA','M'),
                           (3,'NEHAM',945459999,'BHOPAL','F'),
                           (4,'MEGHANA',999432399,'Indore','F'),
                           (5,'PULKITA',78959954599,'Mysore','M');
